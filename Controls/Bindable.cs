...
namespace BindableApplicationBar
{
	...
	public static class Bindable
	{
		...
		/// </returns>
		public static BindableApplicationBar GetApplicationBar(DependencyObject d)
		{
			return (BindableApplicationBar)d.GetValue(ApplicationBarProperty);
		}
		...
		public static void SetApplicationBar(DependencyObject d, BindableApplicationBar value)
		{
		...
		private static void OnApplicationBarChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
		{
			...
			var oldApplicationBar = e.OldValue as BindableApplicationBar;
			var newApplicationBar = (BindableApplicationBar)d.GetValue(ApplicationBarProperty);
