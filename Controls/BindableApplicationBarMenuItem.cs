...
namespace BindableApplicationBar
{
	...
	public class BindableApplicationBarMenuItem : FrameworkElement
	{
		...
		protected IApplicationBarMenuItem applicationBarMenuItem;
		...
		/// </param>
		public virtual void Attach(ApplicationBar parentApplicationBar, int i)
		{
			if (this.applicationBarMenuItem != null)
			{
				return;
			...
			this.applicationBarMenuItem.Click += this.ApplicationBarMenuItemClick;

			try
			{
				this.applicationBar.MenuItems.Insert(i, this.applicationBarMenuItem);
			}
		...
		{
			this.applicationBarMenuItem.Click -= this.ApplicationBarMenuItemClick;
			this.applicationBar.MenuItems.Remove(this.applicationBarMenuItem);
