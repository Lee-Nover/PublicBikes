    ...
    public class BCycleService : AzureServiceProxy
    {
        ...
        protected override IList<City> GetCities()
        {
            var result = new List<City>() {
                ...
                new City(){ CityName = "Cincinnatti", Country = "United States", ServiceName = "Cincy Red Bike", UrlCityName = "cincinnatti", Provider = Instance },
                ...
                new City(){ CityName = "SaltLake City", Country = "United States", ServiceName = "GREENbike", UrlCityName = "saltlake", Provider = Instance },
