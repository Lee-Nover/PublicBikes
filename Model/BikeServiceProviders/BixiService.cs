    ...
    public class BixiService : BikeServiceProvider
    {
        ...
        protected override IList<City> GetCities()
        {
            var result = new List<City>() {
                ...
                new City(){ CityName = "San Francisco", Country = "United States", ServiceName = "Bay Area Bike Share", UrlCityName = "sanfrancisco", AlternateCityName = "bay areay", Provider = Instance },
