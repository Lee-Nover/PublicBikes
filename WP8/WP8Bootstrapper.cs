...
namespace Bicikelj
{
    public class WP8Bootstrapper : PhoneBootstrapper
    {
        ...
        static void AddCustomConventions()
        {
            ...
            ConventionManager.AddElementConvention<Microsoft.Phone.Maps.Toolkit.MapItemsControl>(ItemsControl.ItemsSourceProperty, "DataContext", "Loaded");
            ConventionManager.AddElementConvention<Microsoft.Phone.Maps.Toolkit.Pushpin>(ContentControl.ContentProperty, "DataContext", "Tap");
            ConventionManager.AddElementConvention<Microsoft.Phone.Maps.Controls.Map>(Microsoft.Phone.Maps.Controls.Map.DataContextProperty, "DataContext", "Tap");
